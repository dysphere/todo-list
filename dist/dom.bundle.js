...
const todolist = (() => {
    let projectArray = []
    const unsort = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.projectFactory)("Unsorted", "Where unsorted todos go")
    projectArray.push(unsort)

    const newproject = (title, description) => {
        let project = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.projectFactory)(title, description)
        projectArray.push(project);
    }

    const newtodo = (title, description, dueDate, priority, completion, projectname = "Unsorted") => {
        let todo = (0,_todos__WEBPACK_IMPORTED_MODULE_0__.todoFactory)(title, description, dueDate, priority, completion)
...
todolist.newtodo("Read", "read a book", (0,date_fns_formatRelative__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns_addDays__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 7), new Date()), "High", false)
todolist.viewtodo()
